...
export const fetchUserProfile = () => {
  return (dispatch) => {
    fetch("https://infinity-talk.herokuapp.com/users/profile", {
      method: "GET",
      headers: {
...
export const uploadAvatar = (file) => {
  return (dispatch) => {
    ...
    fetch('https://infinity-talk.herokuapp.com/users/updateImg', {
      method: 'PATCH',
      headers: {
...
export const editUserProfile = (
  ...
  return (dispatch) => {
    fetch('https://infinity-talk.herokuapp.com/users/edit', {
      method: 'PATCH',
      headers: {
        'Content-type': 'application/json',
        Authorization: `Bearer ${localStorage.getItem('token')}`,
