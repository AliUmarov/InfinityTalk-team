          ...
          filteredChats.map((chat) => {
            return (
              <div className={`chats-item ${chat.selected ? 'selected-chat' : ''}`} onClick={() => handleChatItemClick(chat._id)}>
                <img src={chat.members[0]._id === mainUser._id ? (chat.members[1].img ? `https://infinity-talk.herokuapp.com/${chat.members[1].img}` : "https://infinity-talk.herokuapp.com/uploads/default-photo.png") : (chat.members[0].img ? `https://infinity-talk.herokuapp.com/${chat.members[0].img}` : "https://infinity-talk.herokuapp.com/uploads/default-photo.png")} className='img-locu' alt=""/>
